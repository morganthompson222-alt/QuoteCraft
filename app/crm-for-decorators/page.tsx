...
export const metadata: Metadata = {
  title: "CRM for Decorators | Decorating Business Software | JobStacker",
  description: "JobStacker helps decorators manage customers, quotes, paint estimates and project scheduling. Run your decorating business with less paperwork.",
  alternates: { canonical: "https://jobstacker.app/crm-for-decorators" },
};

export default function Page() {
  return (
    <TradePageLayout trade="decorators">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Decorators</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps decorators manage customers, quotes, paint estimates and project scheduling. Run your decorating business with less paperwork.
      </p>
      <h2>Why decorators need a proper CRM</h2>
      <p>
        Running a decorators business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for decorators</h2>
