...
export const metadata: Metadata = {
  title: "Business Management Software for Tradespeople | JobStacker",
  description: "JobStacker is all-in-one business management software for tradespeople. Manage customers, quotes, jobs, invoices, and scheduling from one platform.",
  alternates: { canonical: "https://jobstacker.app/business-management-software" },
};
