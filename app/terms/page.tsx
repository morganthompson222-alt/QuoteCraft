    ...
    <section className="page">
      <div className="page__inner" style={{ maxWidth: 720 }}>
        ...
        <div className="legal-content">
          ...
          <p>You may enter personal data relating to your customers into the Service (such as names, email addresses, and postal addresses). By doing so, you warrant that: (a) you have a lawful basis under applicable data protection law (including the UK GDPR) for processing that personal data; (b) you have provided your customers with appropriate privacy notices describing how their data will be processed, including its entry into a third-party SaaS platform; and (c) you will comply with all applicable data protection laws in connection with your use of the Service. You remain the data controller in respect of your customers&rsquo; personal data. QuoteCraft acts as a data processor on your behalf in respect of that data. Where required, we will enter into a Data Processing Agreement with you on request.</p>
