...
export const metadata: Metadata = {
  title: "CRM for Property Maintenance | Maintenance Software | JobStacker",
  description: "JobStacker helps property maintenance professionals manage tenants, landlords, quotes and job tracking. Simplify your maintenance business.",
  alternates: { canonical: "https://jobstacker.app/crm-for-property-maintenance" },
};

export default function Page() {
  return (
    <TradePageLayout trade="property-maintenance">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Property Maintenance</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps property maintenance professionals manage tenants, landlords, quotes and job tracking. Simplify your maintenance business.
      </p>
      <h2>Why property maintenance need a proper CRM</h2>
      <p>
        Running a property maintenance business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for property maintenance</h2>
