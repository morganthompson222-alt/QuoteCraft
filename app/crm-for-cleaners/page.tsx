...
export const metadata: Metadata = {
  title: "CRM for Cleaners | Cleaning Business Software | JobStacker",
  description: "JobStacker helps cleaners manage customers, recurring schedules, quotes and payments. Run your cleaning business from your phone.",
  alternates: { canonical: "https://jobstacker.app/crm-for-cleaners" },
};

export default function Page() {
  return (
    <TradePageLayout trade="cleaners">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Cleaners</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps cleaners manage customers, recurring schedules, quotes and payments. Run your cleaning business from your phone.
      </p>
      <h2>Why cleaners need a proper CRM</h2>
      <p>
        Running a cleaners business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for cleaners</h2>
