...
export const metadata: Metadata = {
  title: "CRM for Pool Maintenance | Pool Service Software | JobStacker",
  description: "JobStacker helps pool maintenance professionals manage customers, service schedules and chemical tracking. Run your pool business from your phone.",
  alternates: { canonical: "https://jobstacker.app/crm-for-pool-maintenance" },
};

export default function Page() {
  return (
    <TradePageLayout trade="pool-maintenance">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Pool Maintenance</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps pool maintenance professionals manage customers, service schedules and chemical tracking. Run your pool business from your phone.
      </p>
      <h2>Why pool maintenance need a proper CRM</h2>
      <p>
        Running a pool maintenance business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for pool maintenance</h2>
