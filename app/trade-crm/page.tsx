...
export const metadata: Metadata = {
  title: "Trade CRM Software | Business Management for Trades | JobStacker",
  description: "JobStacker is CRM software built specifically for tradespeople. Manage customers, quotes, jobs, and invoices from one simple platform.",
  alternates: { canonical: "https://jobstacker.app/trade-crm" },
};

export default function Page() {
  return (
    <section style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
      <Breadcrumbs items={{ label: "Home", href: "/" }, {{ label: "Trade Crm Software" }}} />
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>Trade Crm Software</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker is CRM software built specifically for tradespeople. Manage customers, quotes, jobs, and invoices from one simple platform.
      </p>
