...
export const metadata: Metadata = {
  title: "CRM for Pest Control | Pest Management Software | JobStacker",
  description: "JobStacker helps pest control professionals manage customers, treatment plans, quotes and recurring schedules. Run your pest management business from one place.",
  alternates: { canonical: "https://jobstacker.app/crm-for-pest-control" },
};

export default function Page() {
  return (
    <TradePageLayout trade="pest-control">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Pest Control</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps pest control professionals manage customers, treatment plans, quotes and recurring schedules. Run your pest management business from one place.
      </p>
      <h2>Why pest control need a proper CRM</h2>
      <p>
        Running a pest control business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for pest control</h2>
