...
export const metadata: Metadata = {
  title: "CRM for Driveway Cleaners | Pressure Washing Software | JobStacker",
  description: "JobStacker helps driveway cleaners manage customers, quotes and job scheduling. Grow your pressure washing business with less admin.",
  alternates: { canonical: "https://jobstacker.app/crm-for-driveway-cleaners" },
};

export default function Page() {
  return (
    <TradePageLayout trade="driveway-cleaners">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Driveway Cleaners</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps driveway cleaners manage customers, quotes and job scheduling. Grow your pressure washing business with less admin.
      </p>
      <h2>Why driveway cleaners need a proper CRM</h2>
      <p>
        Running a driveway cleaners business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
      ...
      <h2>Key features for driveway cleaners</h2>
