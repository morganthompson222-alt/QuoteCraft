...
export const metadata: Metadata = {
  title: "Work Order Software for Tradespeople | JobStacker",
  description: "JobStacker work order software helps tradespeople create, track, and manage work orders from creation to completion. Simple digital work order management.",
  alternates: { canonical: "https://jobstacker.app/work-order-software" },
};

export default function Page() {
  return (
    <section style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Work Order Software" }]} />
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>Work Order Software</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker work order software helps tradespeople create, track, and manage work orders from creation to completion. Simple digital work order management.
      </p>
