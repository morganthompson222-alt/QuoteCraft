...
export const metadata: Metadata = {
  title: "Client Management Software for Tradespeople | JobStacker",
  description: "JobStacker helps tradespeople manage client records, job history, and communications. Keep every client organised from first enquiry to repeat business.",
  alternates: { canonical: "https://jobstacker.app/client-management-software" },
};
...
export default function Page() {
  return (
    <section style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
      ...
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>Client Management Software</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps tradespeople manage client records, job history, and communications. Keep every client organised from first enquiry to repeat business.
      </p>
