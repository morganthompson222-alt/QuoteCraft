...
export const metadata: Metadata = {
  title: "CRM for HVAC Technicians | Heating & Cooling Software | JobStacker",
  description: "JobStacker helps HVAC technicians manage customers, service calls, quotes and maintenance schedules. Run your heating and cooling business efficiently.",
  alternates: { canonical: "https://jobstacker.app/crm-for-hvac" },
};

export default function Page() {
  return (
    <TradePageLayout trade="hvac">
      <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}>CRM for Hvac</h1>
      <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 32 }}>
        JobStacker helps HVAC technicians manage customers, service calls, quotes and maintenance schedules. Run your heating and cooling business efficiently.
      </p>
      <h2>Why hvac need a proper CRM</h2>
      <p>
        Running a hvac business means managing customer enquiries, sending quotes, scheduling work, and chasing payments. Most tradespeople try to manage this with notebooks and spreadsheets — but as you grow, that stops working.
      </p>
      <p>
