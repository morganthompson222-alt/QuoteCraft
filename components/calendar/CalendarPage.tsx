...
export function CalendarPage() {
  ...
  const CELL: React.CSSProperties = { minHeight: 90, borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}`, padding: 4, display: "flex", flexDirection: "column", background: "#fff", overflow: "hidden" };
