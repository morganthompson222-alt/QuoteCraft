...
const marketingRoutes = new Set(["/", "/login", "/signup", "/blog", "/privacy", "/terms", "/install", "/leads-for-tradespeople", "/quoting-guide-for-tradespeople", "/grow-trade-business", "/trade-business-administration", "/electrician-lead-management-software", "/plumbing-crm-uk", "/trade-business-management-app", "/free-quote-software", "/free-job-management-software", "/cheap-crm-for-tradespeople", "/trade-lead-tracking", "/trade-follow-up-software", "/trade-customer-database", "/trade-quote-tracker", "/trade-business-app"]);
const marketingPrefixes = ["/crm-for-", "/best-crm-for-", "/best-software-for-tradespeople", "/quote-software", "/invoice-software", "/job-management-software", "/scheduling-software", "/crm-software", "/client-management-software", "/customer-management-software", "/lead-management-software", "/trade-crm", "/business-management-software", "/field-service-management", "/work-order-software", "/job-tracking-software", "/jobber-", "/tradify-", "/housecall-pro-", "/servicem8-", "/bigchange-", "/powered-now-", "/commusoft-", "/simpro-", "/fieldedge-", "/workiz-", "/joblogic-", "/free-crm-for-", "/best-field-service", "/best-quoting", "/best-job-management", "/best-crm-for-small", "/uk-", "/electrician-", "/plumber-", "/builder-", "/landscaper-"];
