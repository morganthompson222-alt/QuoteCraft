...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "How Electricians Can Get More Leads",
    excerpt:
      "Stop relying on word of mouth alone. Here are practical ways electricians can generate a steady stream of new customers.",
    category: "Leads",
    readTime: "5 min",
    date: "2026-06-20",
  ...
  },
  {
    ...
    title: "How Plumbers Can Stop Losing Customers",
    excerpt:
      "Plumbing is a relationship business. Here's how to keep customers coming back instead of calling your competitors.",
    category: "Leads",
    readTime: "4 min",
    date: "2026-06-18",
    author: "Morgan Thompson",
  ...
  },
  {
    ...
    title: "How to Price Electrical Work",
    excerpt:
      "Getting your pricing right is the difference between profit and burnout. Here's a framework for pricing electrical work confidently.",
    category: "Quoting",
    readTime: "6 min",
    date: "2026-06-15",
    author: "Morgan Thompson",
  ...
  },
  {
    ...
    title: "How to Write a Professional Plumbing Quote",
    excerpt:
      "A professional quote is your best sales tool. Learn what to include and how to format it for maximum acceptance rates.",
    category: "Quoting",
    readTime: "4 min",
    date: "2026-06-12",
    author: "Morgan Thompson",
    content: [
      "Your quote is often the first professional document a customer sees from your business. It's your opportunity to build trust, demonstrate competence, and differentiate yourself from competitors who send handwritten estimates on scrap paper.",
      ...
      "JobStacker generates professional PDF quotes with all of these elements built in. Your company details, logo, and payment terms are included automatically. Just add the line items and send.",
  ...
  },
  {
    ...
    title: "Best Apps for Tradespeople",
    excerpt:
      "Running a trade business means juggling customers, quotes, jobs, and finances. These are the best apps to make it easier.",
  ...
  },
  {
    ...
    excerpt:
      "Growing a trade business isn't just about doing more work. It's about building systems that scale. Here's how to grow without burning out.",
    category: "Business Growth",
    readTime: "7 min",
    date: "2026-06-08",
    author: "Morgan Thompson",
  ...
  },
  {
    ...
    title: "How to Manage Customers Without Spreadsheets",
    excerpt:
      "Spreadsheets are better than paper, but they're still not the right tool for managing a trade business. Here's what to use instead.",
  ...
  },
  {
    ...
    title: "Best CRM for Tradespeople",
    excerpt:
      "Not all CRM software is created equal. Here's what tradespeople should look for and which options are worth considering.",
    category: "Administration",
    readTime: "5 min",
    date: "2026-06-03",
    author: "Morgan Thompson",
    content: [
      "CRM stands for Customer Relationship Management. In plain English, it's software that helps you manage your customer interactions. For tradespeople, a good CRM should do more than just store contact details — it should help you quote, schedule, invoice, and track every customer interaction.",
      ...
      "A trade-specific CRM like JobStacker is built around how tradespeople actually work. You create a quote, the customer accepts, and the job appears on your calendar. You complete the job, mark it paid, and the customer record is updated. Everything flows naturally from one step to the next.",
      ...
      "JobStacker covers all of these. It's built for UK tradespeople and free to start. Try it and see if it fits your workflow.",
    ],
  },
];
